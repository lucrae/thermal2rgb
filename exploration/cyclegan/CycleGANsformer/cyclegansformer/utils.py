...
class TGenerator(nn.Module):
    def __init__(self):
        ...
        self.stage1 = nn.ModuleList([
            Encoder(8*8*1024, DEPTH, HEADS, 8*8*1024, 8*8*1024),
            Encoder(8*8*1024, DEPTH, HEADS, 8*8*1024, 8*8*1024),
            Encoder(8*8*1024, DEPTH, HEADS, 8*8*1024, 8*8*1024),
            Encoder(8*8*1024, DEPTH, HEADS, 8*8*1024, 8*8*1024),
            Encoder(8*8*1024, DEPTH, HEADS, 8*8*1024, 8*8*1024)
        ...
        self.stage2 = nn.ModuleList([
            Encoder(16*16*256, DEPTH, HEADS, 16*16*256, 16*16*256),
            Encoder(16*16*256, DEPTH, HEADS, 16*16*256, 16*16*256),
            Encoder(16*16*256, DEPTH, HEADS, 16*16*256, 16*16*256),
            Encoder(16*16*256, DEPTH, HEADS, 16*16*256, 16*16*256)
        ])
        ...
        self.stage3 = nn.ModuleList([
            Encoder(16*16*256, DEPTH, HEADS, 32*32*64, 32*32*64),
            Encoder(16*16*256, DEPTH, HEADS, 32*32*64, 32*32*64)
        ])
...
class TDiscriminator(nn.Module):
    def __init__(self):
        ...
        self.stage1 = nn.ModuleList([
            Encoder((8*8+1)*384, DEPTH, HEADS, (8*8+1)*384, (8*8+1)*384),
            Encoder((8*8+1)*384, DEPTH, HEADS, (8*8+1)*384, (8*8+1)*384),
            Encoder((8*8+1)*384, DEPTH, HEADS, (8*8+1)*384, (8*8+1)*384),
            Encoder((8*8+1)*384, DEPTH, HEADS, (8*8+1)*384, (8*8+1)*384),
            Encoder((8*8+1)*384, DEPTH, HEADS, (8*8+1)*384, (8*8+1)*384),
